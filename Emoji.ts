import {fabric, GIF} from "./Vendor.js"
...
export async function createEmoji(options: Options, imageURL: string, func: (_: FabricCanvas, image: RelativeImage, t: number) => Promise<void>) {
