...
var Application = (function () {
    ...
    Application.prototype.initializeEvents = function () {
        ...
        this.imageByUrlDiv.onclick = function () { return __awaiter(_this, void 0, void 0, function () {
            var url, request, arrayBuffer, maybeImageArrayBuffer;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        request = _a.sent();
                        return [4, request.arrayBuffer()];
                    case 3:
                        arrayBuffer = _a.sent();
                        maybeImageArrayBuffer = request.ok ? Option.some(arrayBuffer) : Option.none();
                        maybeImageArrayBuffer.fold(function () { return alert("\u0418\u0437\u043E\u0431\u0440\u0430\u0436\u0435\u043D\u0438\u0435 \u0441 url '" + url + "' \u043D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u043F\u043E\u043B\u0443\u0447\u0438\u0442\u044C"); }, function (arrayBuffer) { return _this.useNewInputImage(arrayBuffer, url.match(/.+\/(.+)$/)[1]); });
                        return [2];
                }
            });
        }); };
    ...
    Application.prototype.useNewInputImage = function (data, fullFileName) {
        var _this = this;
